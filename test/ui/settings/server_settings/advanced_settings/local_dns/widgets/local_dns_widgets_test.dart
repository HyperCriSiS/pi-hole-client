...
void main() async {
  ...
  group('AddLocalDnsModal', () {
    ...
    testWidgets('normalizes multiple hostnames and trims IP on add', (
      WidgetTester tester,
    ) async {
      Map<String, dynamic>? submitted;
      await tester.pumpWidget(
  ...
  group('EditLocalDnsModal (name)', () {
    ...
    testWidgets('normalizes multiple hostnames on edit', (
      WidgetTester tester,
    ) async {
      String? confirmedName;
      await tester.pumpWidget(
