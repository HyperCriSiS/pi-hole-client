...
class DevicesDevicesInner {
  ...
  @JsonKey(name: r'firstSeen', required: false, includeIfNull: false)
  final int? firstSeen;
  ...
  @JsonKey(name: r'numQueries', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'ips', required: false, includeIfNull: false)
  final List<DevicesDevicesInnerIpsInner>? ips;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is DevicesDevicesInner &&
          other.id == id &&
          other.hwaddr == hwaddr &&
  ...
  factory DevicesDevicesInner.fromJson(Map<String, dynamic> json) =>
      _$DevicesDevicesInnerFromJson(json);
