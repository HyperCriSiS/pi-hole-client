...
class MetricsMetricsDhcp {
  ...
  /// Number of DHCP ACKs
  @JsonKey(name: r'ack', required: false, includeIfNull: false)
  final int? ack;

  /// Number of DHCP NAKs
  @JsonKey(name: r'nak', required: false, includeIfNull: false)
  final int? nak;

  /// Number of DHCP declines
  @JsonKey(name: r'decline', required: false, includeIfNull: false)
  final int? decline;
  ...
  @JsonKey(name: r'discover', required: false, includeIfNull: false)
  final int? discover;

  /// Number of DHCP informs
  @JsonKey(name: r'inform', required: false, includeIfNull: false)
  final int? inform;

  /// Number of DHCP requests
  @JsonKey(name: r'request', required: false, includeIfNull: false)
  final int? request;
  ...
  factory MetricsMetricsDhcp.fromJson(Map<String, dynamic> json) =>
      _$MetricsMetricsDhcpFromJson(json);
