...
class Get4ListsInner {
  /// Returns a new [Get4ListsInner] instance.
  Get4ListsInner({
    this.address,
  ...
  final Get4ListsInnerTypeEnum? type;
  ...
  factory Get4ListsInner.fromJson(Map<String, dynamic> json) =>
      _$Get4ListsInnerFromJson(json);

  Map<String, dynamic> toJson() => _$Get4ListsInnerToJson(this);
...
enum Get4ListsInnerTypeEnum {
  ...
  const Get4ListsInnerTypeEnum(this.value);
