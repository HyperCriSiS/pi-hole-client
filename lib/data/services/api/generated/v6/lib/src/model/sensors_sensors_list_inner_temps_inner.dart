...
class SensorsSensorsListInnerTempsInner {
  ...
  @JsonKey(name: r'crit', required: false, includeIfNull: false)
  final num? crit;

  /// Short path of temperature sensor
  @JsonKey(name: r'sensor', required: false, includeIfNull: false)
  final String? sensor;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is SensorsSensorsListInnerTempsInner &&
          other.name == name &&
          other.value == value &&
          other.max == max &&
          other.crit == crit &&
  ...
  factory SensorsSensorsListInnerTempsInner.fromJson(
    Map<String, dynamic> json,
  ) => _$SensorsSensorsListInnerTempsInnerFromJson(json);

  Map<String, dynamic> toJson() =>
      _$SensorsSensorsListInnerTempsInnerToJson(this);
