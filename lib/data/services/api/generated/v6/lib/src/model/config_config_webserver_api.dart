...
class ConfigConfigWebserverApi {
  ...
  @JsonKey(name: r'max_sessions', required: false, includeIfNull: false)
  final int? maxSessions;

  @JsonKey(name: r'prettyJSON', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'pwhash', required: false, includeIfNull: false)
  final String? pwhash;

  @JsonKey(name: r'totp_secret', required: false, includeIfNull: false)
  final String? totpSecret;

  @JsonKey(name: r'app_pwhash', required: false, includeIfNull: false)
  final String? appPwhash;

  @JsonKey(name: r'app_sudo', required: false, includeIfNull: false)
  final bool? appSudo;

  @JsonKey(name: r'cli_pw', required: false, includeIfNull: false)
  final bool? cliPw;

  @JsonKey(name: r'excludeClients', required: false, includeIfNull: false)
  final List<String>? excludeClients;

  @JsonKey(name: r'excludeDomains', required: false, includeIfNull: false)
  final List<String>? excludeDomains;

  @JsonKey(name: r'maxHistory', required: false, includeIfNull: false)
  final int? maxHistory;

  @JsonKey(name: r'maxClients', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'allow_destructive', required: false, includeIfNull: false)
  final bool? allowDestructive;

  @JsonKey(name: r'temp', required: false, includeIfNull: false)
  final ConfigConfigWebserverApiTemp? temp;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is ConfigConfigWebserverApi &&
  ...
  factory ConfigConfigWebserverApi.fromJson(Map<String, dynamic> json) =>
      _$ConfigConfigWebserverApiFromJson(json);
