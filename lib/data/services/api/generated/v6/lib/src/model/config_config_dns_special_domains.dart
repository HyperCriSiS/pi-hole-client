...
class ConfigConfigDnsSpecialDomains {
  ...
  @JsonKey(name: r'mozillaCanary', required: false, includeIfNull: false)
  final bool? mozillaCanary;

  @JsonKey(name: r'iCloudPrivateRelay', required: false, includeIfNull: false)
  final bool? iCloudPrivateRelay;

  @JsonKey(name: r'designatedResolver', required: false, includeIfNull: false)
  final bool? designatedResolver;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is ConfigConfigDnsSpecialDomains &&
  ...
  factory ConfigConfigDnsSpecialDomains.fromJson(Map<String, dynamic> json) =>
      _$ConfigConfigDnsSpecialDomainsFromJson(json);
