...
part 'get3_clients_inner.g.dart';
...
class Get3ClientsInner {
  /// Returns a new [Get3ClientsInner] instance.
  Get3ClientsInner({
    this.client,
  ...
  factory Get3ClientsInner.fromJson(Map<String, dynamic> json) =>
      _$Get3ClientsInnerFromJson(json);

  Map<String, dynamic> toJson() => _$Get3ClientsInnerToJson(this);
