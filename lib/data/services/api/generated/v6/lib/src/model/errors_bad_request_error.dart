...
class ErrorsBadRequestError {
  ...
  ErrorsBadRequestError({this.key, this.message, this.hint});
  ...
  bool operator ==(Object other) =>
      ...
      other is ErrorsBadRequestError &&
          other.key == key &&
  ...
  factory ErrorsBadRequestError.fromJson(Map<String, dynamic> json) =>
      _$ErrorsBadRequestErrorFromJson(json);
