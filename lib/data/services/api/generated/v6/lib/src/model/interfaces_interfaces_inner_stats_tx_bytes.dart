...
class InterfacesInterfacesInnerStatsTxBytes {
  ...
  InterfacesInterfacesInnerStatsTxBytes({this.value, this.unit});
  ...
  bool operator ==(Object other) =>
      ...
      other is InterfacesInterfacesInnerStatsTxBytes &&
          other.value == value &&
          other.unit == unit;
  ...
  factory InterfacesInterfacesInnerStatsTxBytes.fromJson(
    Map<String, dynamic> json,
  ) => _$InterfacesInterfacesInnerStatsTxBytesFromJson(json);

  Map<String, dynamic> toJson() =>
      _$InterfacesInterfacesInnerStatsTxBytesToJson(this);
