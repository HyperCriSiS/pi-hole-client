...
class PostTeleporterRequestImportGravity {
  ...
  @JsonKey(name: r'adlist', required: false, includeIfNull: false)
  final bool? adlist;

  /// Import Pi-hole's table relating adlist entries to groups
  @JsonKey(name: r'adlist_by_group', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'domainlist_by_group', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'client_by_group', required: false, includeIfNull: false)
  final bool? clientByGroup;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is PostTeleporterRequestImportGravity &&
          other.group == group &&
          other.adlist == adlist &&
  ...
  factory PostTeleporterRequestImportGravity.fromJson(
    Map<String, dynamic> json,
  ) => _$PostTeleporterRequestImportGravityFromJson(json);

  Map<String, dynamic> toJson() =>
      _$PostTeleporterRequestImportGravityToJson(this);
