...
class ComponentsSchemasListsProcessedProcessedErrorsInner {
  ...
  ComponentsSchemasListsProcessedProcessedErrorsInner({this.item, this.error});
  ...
  bool operator ==(Object other) =>
      ...
      other is ComponentsSchemasListsProcessedProcessedErrorsInner &&
          other.item == item &&
          other.error == error;
  ...
  factory ComponentsSchemasListsProcessedProcessedErrorsInner.fromJson(
    Map<String, dynamic> json,
  ) => _$ComponentsSchemasListsProcessedProcessedErrorsInnerFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ComponentsSchemasListsProcessedProcessedErrorsInnerToJson(this);
