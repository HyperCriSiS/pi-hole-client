...
class QueriesClients {
  ...
  QueriesClients({this.active, this.total});
  ...
  bool operator ==(Object other) =>
      ...
      other is QueriesClients && other.active == active && other.total == total;

  @override
  int get hashCode => active.hashCode + total.hashCode;

  factory QueriesClients.fromJson(Map<String, dynamic> json) =>
      _$QueriesClientsFromJson(json);
