...
class PaddIface {
  ...
  PaddIface({this.v4, this.v6});

  @JsonKey(name: r'v4', required: false, includeIfNull: false)
  final PaddIfaceV4? v4;

  @JsonKey(name: r'v6', required: false, includeIfNull: false)
  final PaddIfaceV6? v6;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is PaddIface && other.v4 == v4 && other.v6 == v6;

  @override
  int get hashCode => v4.hashCode + v6.hashCode;
