...
class ConfigConfigDns {
  ...
  @JsonKey(name: r'CNAMEdeepInspect', required: false, includeIfNull: false)
  final bool? cNAMEdeepInspect;

  @JsonKey(name: r'blockESNI', required: false, includeIfNull: false)
  final bool? blockESNI;

  @JsonKey(name: r'EDNS0ECS', required: false, includeIfNull: false)
  final bool? eDNS0ECS;

  @JsonKey(name: r'ignoreLocalhost', required: false, includeIfNull: false)
  final bool? ignoreLocalhost;

  @JsonKey(name: r'showDNSSEC', required: false, includeIfNull: false)
  final bool? showDNSSEC;

  @JsonKey(name: r'analyzeOnlyAandAAAA', required: false, includeIfNull: false)
  final bool? analyzeOnlyAandAAAA;

  @JsonKey(name: r'piholePTR', required: false, includeIfNull: false)
  final String? piholePTR;

  @JsonKey(name: r'replyWhenBusy', required: false, includeIfNull: false)
  final String? replyWhenBusy;

  @JsonKey(name: r'blockTTL', required: false, includeIfNull: false)
  final int? blockTTL;

  @JsonKey(name: r'hosts', required: false, includeIfNull: false)
  final List<String>? hosts;

  @JsonKey(name: r'domainNeeded', required: false, includeIfNull: false)
  final bool? domainNeeded;

  @JsonKey(name: r'expandHosts', required: false, includeIfNull: false)
  final bool? expandHosts;

  @JsonKey(name: r'domain', required: false, includeIfNull: false)
  final ConfigConfigDnsDomain? domain;

  @JsonKey(name: r'bogusPriv', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'hostRecord', required: false, includeIfNull: false)
  final String? hostRecord;

  @JsonKey(name: r'listeningMode', required: false, includeIfNull: false)
  final String? listeningMode;

  @JsonKey(name: r'queryLogging', required: false, includeIfNull: false)
  final bool? queryLogging;

  @JsonKey(name: r'cnameRecords', required: false, includeIfNull: false)
  final List<String>? cnameRecords;

  @JsonKey(name: r'port', required: false, includeIfNull: false)
  final int? port;

  @JsonKey(name: r'localise', required: false, includeIfNull: false)
  final bool? localise;

  @JsonKey(name: r'cache', required: false, includeIfNull: false)
  final ConfigConfigDnsCache? cache;

  @JsonKey(name: r'revServers', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'specialDomains', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'rateLimit', required: false, includeIfNull: false)
  final ConfigConfigDnsRateLimit? rateLimit;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is ConfigConfigDns &&
  ...
  factory ConfigConfigDns.fromJson(Map<String, dynamic> json) =>
      _$ConfigConfigDnsFromJson(json);
