...
class UpstreamsUpstreamsInner {
  ...
  @JsonKey(name: r'statistics', required: false, includeIfNull: false)
  final UpstreamsUpstreamsInnerStatistics? statistics;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is UpstreamsUpstreamsInner &&
          other.ip == ip &&
          other.name == name &&
          other.port == port &&
          other.count == count &&
  ...
  factory UpstreamsUpstreamsInner.fromJson(Map<String, dynamic> json) =>
      _$UpstreamsUpstreamsInnerFromJson(json);
