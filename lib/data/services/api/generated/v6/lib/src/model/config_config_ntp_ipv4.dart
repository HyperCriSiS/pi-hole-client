...
class ConfigConfigNtpIpv4 {
  ...
  ConfigConfigNtpIpv4({this.active, this.address});
  ...
  factory ConfigConfigNtpIpv4.fromJson(Map<String, dynamic> json) =>
      _$ConfigConfigNtpIpv4FromJson(json);
