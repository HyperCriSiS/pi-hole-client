...
class DevicesDevicesInnerIpsInner {
  ...
  @JsonKey(name: r'lastSeen', required: false, includeIfNull: false)
  final int? lastSeen;

  /// Unix timestamp when device updated its hostname the last time
  @JsonKey(name: r'nameUpdated', required: false, includeIfNull: false)
  final int? nameUpdated;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is DevicesDevicesInnerIpsInner &&
          other.ip == ip &&
          other.name == name &&
  ...
  factory DevicesDevicesInnerIpsInner.fromJson(Map<String, dynamic> json) =>
      _$DevicesDevicesInnerIpsInnerFromJson(json);
