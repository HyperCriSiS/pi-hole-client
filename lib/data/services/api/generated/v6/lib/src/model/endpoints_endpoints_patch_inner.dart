...
class EndpointsEndpointsPatchInner {
  ...
  EndpointsEndpointsPatchInner({this.uri, this.parameters});
  ...
  bool operator ==(Object other) =>
      ...
      other is EndpointsEndpointsPatchInner &&
          other.uri == uri &&
  ...
  factory EndpointsEndpointsPatchInner.fromJson(Map<String, dynamic> json) =>
      _$EndpointsEndpointsPatchInnerFromJson(json);
