...
class MetricsMetricsDhcpLeases {
  ...
  @JsonKey(name: r'allocated_4', required: false, includeIfNull: false)
  final int? allocated4;

  /// Number of pruned IPv4 leases
  @JsonKey(name: r'pruned_4', required: false, includeIfNull: false)
  final int? pruned4;

  /// Number of allocated IPv6 leases
  @JsonKey(name: r'allocated_6', required: false, includeIfNull: false)
  final int? allocated6;

  /// Number of pruned IPv6 leases
  @JsonKey(name: r'pruned_6', required: false, includeIfNull: false)
  final int? pruned6;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is MetricsMetricsDhcpLeases &&
  ...
  factory MetricsMetricsDhcpLeases.fromJson(Map<String, dynamic> json) =>
      _$MetricsMetricsDhcpLeasesFromJson(json);
