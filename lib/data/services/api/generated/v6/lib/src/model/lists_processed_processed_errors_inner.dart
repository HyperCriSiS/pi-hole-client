...
class ListsProcessedProcessedErrorsInner {
  ...
  ListsProcessedProcessedErrorsInner({this.item, this.error});
  ...
  bool operator ==(Object other) =>
      ...
      other is ListsProcessedProcessedErrorsInner &&
          other.item == item &&
          other.error == error;
  ...
  factory ListsProcessedProcessedErrorsInner.fromJson(
    Map<String, dynamic> json,
  ) => _$ListsProcessedProcessedErrorsInnerFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ListsProcessedProcessedErrorsInnerToJson(this);
