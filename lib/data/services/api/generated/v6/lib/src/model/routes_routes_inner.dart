...
class RoutesRoutesInner {
  ...
  @JsonKey(name: r'table', required: false, includeIfNull: false)
  final int? table;
  ...
  /// Outgoing interface
  @JsonKey(name: r'oif', required: false, includeIfNull: false)
  final String? oif;

  /// Incoming interface
  @JsonKey(name: r'iif', required: false, includeIfNull: false)
  final String? iif;

  /// Destination address (or \"default\" for the default route)
  @JsonKey(name: r'dst', required: false, includeIfNull: false)
  final String? dst;
  ...
  @JsonKey(name: r'prefsrc', required: false, includeIfNull: false)
  ...
  /// Route preference
  @JsonKey(name: r'pref', required: false, includeIfNull: false)
  final int? pref;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is RoutesRoutesInner &&
  ...
  factory RoutesRoutesInner.fromJson(Map<String, dynamic> json) =>
      _$RoutesRoutesInnerFromJson(json);
