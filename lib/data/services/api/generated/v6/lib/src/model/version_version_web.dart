...
class VersionVersionWeb {
  ...
  VersionVersionWeb({this.local, this.remote});
  ...
  factory VersionVersionWeb.fromJson(Map<String, dynamic> json) =>
      _$VersionVersionWebFromJson(json);
