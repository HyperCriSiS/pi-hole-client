...
class TotpTotp {
  ...
  @JsonKey(name: r'issuer', required: false, includeIfNull: false)
  final String? issuer;

  @JsonKey(name: r'algorithm', required: false, includeIfNull: false)
  final String? algorithm;

  @JsonKey(name: r'digits', required: false, includeIfNull: false)
  final int? digits;
  ...
  @JsonKey(name: r'codes', required: false, includeIfNull: false)
  ...
  factory TotpTotp.fromJson(Map<String, dynamic> json) =>
      _$TotpTotpFromJson(json);
