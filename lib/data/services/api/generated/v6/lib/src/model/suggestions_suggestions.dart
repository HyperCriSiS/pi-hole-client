...
class SuggestionsSuggestions {
  ...
  @JsonKey(name: r'client_ip', required: false, includeIfNull: false)
  final List<String>? clientIp;

  /// Array of suggested client names
  @JsonKey(name: r'client_name', required: false, includeIfNull: false)
  ...
  bool operator ==(Object other) =>
      ...
      other is SuggestionsSuggestions &&
          other.domain == domain &&
  ...
  factory SuggestionsSuggestions.fromJson(Map<String, dynamic> json) =>
      _$SuggestionsSuggestionsFromJson(json);
