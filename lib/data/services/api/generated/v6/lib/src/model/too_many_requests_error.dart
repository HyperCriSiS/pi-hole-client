...
class TooManyRequestsError {
  ...
  TooManyRequestsError({this.key, this.message, this.hint});
  ...
  factory TooManyRequestsError.fromJson(Map<String, dynamic> json) =>
      _$TooManyRequestsErrorFromJson(json);
