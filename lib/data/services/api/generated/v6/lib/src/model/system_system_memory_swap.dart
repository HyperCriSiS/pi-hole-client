...
class SystemSystemMemorySwap {
  ...
  SystemSystemMemorySwap({this.total, this.used, this.free, this.percentUsed});
  ...
  bool operator ==(Object other) =>
      ...
      other is SystemSystemMemorySwap &&
          other.total == total &&
          other.used == used &&
          other.free == free &&
  ...
  @override
  int get hashCode =>
      total.hashCode + used.hashCode + free.hashCode + percentUsed.hashCode;

  factory SystemSystemMemorySwap.fromJson(Map<String, dynamic> json) =>
      _$SystemSystemMemorySwapFromJson(json);
