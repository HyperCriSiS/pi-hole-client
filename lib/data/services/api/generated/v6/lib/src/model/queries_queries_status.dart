...
class QueriesQueriesStatus {
  ...
  @JsonKey(name: r'DENYLIST', required: false, includeIfNull: false)
  final int? DENYLIST;

  /// Type EXTERNAL_BLOCKED_IP queries
  @JsonKey(name: r'EXTERNAL_BLOCKED_IP', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'GRAVITY_CNAME', required: false, includeIfNull: false)
  final int? GRAVITY_CNAME;

  /// Type REGEX_CNAME queries
  @JsonKey(name: r'REGEX_CNAME', required: false, includeIfNull: false)
  final int? REGEX_CNAME;

  /// Type DENYLIST_CNAME queries
  @JsonKey(name: r'DENYLIST_CNAME', required: false, includeIfNull: false)
  final int? DENYLIST_CNAME;

  /// Type RETRIED queries
  @JsonKey(name: r'RETRIED', required: false, includeIfNull: false)
  final int? RETRIED;

  /// Type RETRIED_DNSSEC queries
  @JsonKey(name: r'RETRIED_DNSSEC', required: false, includeIfNull: false)
  final int? RETRIED_DNSSEC;

  /// Type IN_PROGRESS queries
  @JsonKey(name: r'IN_PROGRESS', required: false, includeIfNull: false)
  final int? IN_PROGRESS;

  /// Type DBBUSY queries
  @JsonKey(name: r'DBBUSY', required: false, includeIfNull: false)
  final int? DBBUSY;

  /// Type SPECIAL_DOMAIN queries
  @JsonKey(name: r'SPECIAL_DOMAIN', required: false, includeIfNull: false)
  final int? SPECIAL_DOMAIN;

  /// Type CACHE_STALE queries
  @JsonKey(name: r'CACHE_STALE', required: false, includeIfNull: false)
  ...
  factory QueriesQueriesStatus.fromJson(Map<String, dynamic> json) =>
      _$QueriesQueriesStatusFromJson(json);
