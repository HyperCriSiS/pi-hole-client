...
class MetricsMetricsDnsReplies {
  ...
  @JsonKey(name: r'unanswered', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'optimized', required: false, includeIfNull: false)
  final int? optimized;
  ...
  bool operator ==(Object other) =>
      ...
      other is MetricsMetricsDnsReplies &&
  ...
  factory MetricsMetricsDnsReplies.fromJson(Map<String, dynamic> json) =>
      _$MetricsMetricsDnsRepliesFromJson(json);
