...
class ConfigConfigDebug {
  ...
  @JsonKey(name: r'networking', required: false, includeIfNull: false)
  final bool? networking;

  @JsonKey(name: r'locks', required: false, includeIfNull: false)
  final bool? locks;
  ...
  @JsonKey(name: r'gc', required: false, includeIfNull: false)
  final bool? gc;

  @JsonKey(name: r'arp', required: false, includeIfNull: false)
  final bool? arp;
  ...
  @JsonKey(name: r'overtime', required: false, includeIfNull: false)
  final bool? overtime;

  @JsonKey(name: r'status', required: false, includeIfNull: false)
  final bool? status;

  @JsonKey(name: r'caps', required: false, includeIfNull: false)
  final bool? caps;

  @JsonKey(name: r'dnssec', required: false, includeIfNull: false)
  final bool? dnssec;

  @JsonKey(name: r'vectors', required: false, includeIfNull: false)
  final bool? vectors;

  @JsonKey(name: r'resolver', required: false, includeIfNull: false)
  final bool? resolver;

  @JsonKey(name: r'edns0', required: false, includeIfNull: false)
  final bool? edns0;

  @JsonKey(name: r'clients', required: false, includeIfNull: false)
  final bool? clients;

  @JsonKey(name: r'aliasclients', required: false, includeIfNull: false)
  final bool? aliasclients;

  @JsonKey(name: r'events', required: false, includeIfNull: false)
  final bool? events;

  @JsonKey(name: r'helper', required: false, includeIfNull: false)
  final bool? helper;

  @JsonKey(name: r'config', required: false, includeIfNull: false)
  final bool? config;

  @JsonKey(name: r'inotify', required: false, includeIfNull: false)
  final bool? inotify;
  ...
  @JsonKey(name: r'netlink', required: false, includeIfNull: false)
  final bool? netlink;
  ...
  factory ConfigConfigDebug.fromJson(Map<String, dynamic> json) =>
      _$ConfigConfigDebugFromJson(json);
