...
class ListsComponentsSchemasListsProcessedProcessedErrorsInner {
  ...
  bool operator ==(Object other) =>
      ...
      other is ListsComponentsSchemasListsProcessedProcessedErrorsInner &&
          other.item == item &&
          other.error == error;
  ...
  factory ListsComponentsSchemasListsProcessedProcessedErrorsInner.fromJson(
    Map<String, dynamic> json,
  ) => _$ListsComponentsSchemasListsProcessedProcessedErrorsInnerFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ListsComponentsSchemasListsProcessedProcessedErrorsInnerToJson(this);
