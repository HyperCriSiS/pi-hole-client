...
class VersionVersionFtlLocal {
  ...
  VersionVersionFtlLocal({this.branch, this.version, this.hash, this.date});
  ...
  bool operator ==(Object other) =>
      ...
      other is VersionVersionFtlLocal &&
          other.branch == branch &&
  ...
  factory VersionVersionFtlLocal.fromJson(Map<String, dynamic> json) =>
      _$VersionVersionFtlLocalFromJson(json);
