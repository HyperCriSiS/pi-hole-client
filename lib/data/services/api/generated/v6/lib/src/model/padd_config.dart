...
class PaddConfig {
  ...
  /// DHCP server status
  @JsonKey(name: r'dhcp_active', required: false, includeIfNull: false)
  final bool? dhcpActive;

  /// DHCP start address
  @JsonKey(name: r'dhcp_start', required: false, includeIfNull: false)
  final String? dhcpStart;

  /// DHCP end address
  @JsonKey(name: r'dhcp_end', required: false, includeIfNull: false)
  final String? dhcpEnd;

  /// DHCPv6 server status
  @JsonKey(name: r'dhcp_ipv6', required: false, includeIfNull: false)
  final bool? dhcpIpv6;

  /// DNS domain
  @JsonKey(name: r'dns_domain', required: false, includeIfNull: false)
  final String? dnsDomain;

  /// DNS port
  @JsonKey(name: r'dns_port', required: false, includeIfNull: false)
  final int? dnsPort;

  /// Number of upstream DNS servers
  @JsonKey(name: r'dns_num_upstreams', required: false, includeIfNull: false)
  final int? dnsNumUpstreams;

  /// DNSSEC status
  @JsonKey(name: r'dns_dnssec', required: false, includeIfNull: false)
  final bool? dnsDnssec;

  /// Reverse DNS server status
  @JsonKey(name: r'dns_revServer_active', required: false, includeIfNull: false)
  final bool? dnsRevServerActive;

  /// Privacy level
  @JsonKey(name: r'privacy_level', required: false, includeIfNull: false)
