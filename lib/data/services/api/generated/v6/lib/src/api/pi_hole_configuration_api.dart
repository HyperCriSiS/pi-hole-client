...
class PiHoleConfigurationApi {
  ...
  Future<Response<void>> addArrayItem({
    ...
    final _path = r'/config/{element}/{value}'
        .replaceAll(
          '{'
          r'element'
          '}',
  ...
  Future<Response<GetConfig200Response>> getConfig({
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<GetConfig200Response, GetConfig200Response>(
              rawData,
  ...
  /// Returns a [Future] containing a [Response] with a [GetConfig200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetConfig200Response>> getConfigElem({
    required String element,
    bool? detailed = false,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/config/{element}'.replaceAll(
      '{'
      r'element'
      '}',
      element.toString(),
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetConfigProps200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetConfigProps200Response>> getConfigProps({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/config/_properties';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    GetConfigProps200Response? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<GetConfigProps200Response, GetConfigProps200Response>(
              rawData,
    ...
    return Response<GetConfigProps200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<PostTeleporter200Response>> postTeleporter({
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<PostTeleporter200Response, PostTeleporter200Response>(
              rawData,
