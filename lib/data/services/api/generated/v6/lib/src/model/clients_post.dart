...
class ClientsPost {
  ...
  ClientsPost({this.client, this.comment, this.groups = const [0]});
  ...
  factory ClientsPost.fromJson(Map<String, dynamic> json) =>
      _$ClientsPostFromJson(json);
