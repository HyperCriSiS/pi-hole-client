...
class GatewayGatewayInner {
  ...
  GatewayGatewayInner({this.family, this.interface_, this.address, this.local});
  ...
  @override
  int get hashCode =>
      family.hashCode + interface_.hashCode + address.hashCode + local.hashCode;

  factory GatewayGatewayInner.fromJson(Map<String, dynamic> json) =>
      _$GatewayGatewayInnerFromJson(json);
