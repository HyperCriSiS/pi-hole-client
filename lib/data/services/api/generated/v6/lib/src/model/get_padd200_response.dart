...
class GetPadd200Response {
  ...
  @JsonKey(name: r'recent_blocked', required: false, includeIfNull: false)
  final String? recentBlocked;

  /// Most requested domain
  @JsonKey(name: r'top_domain', required: false, includeIfNull: false)
  final String? topDomain;

  /// Most blocked domain
  @JsonKey(name: r'top_blocked', required: false, includeIfNull: false)
  final String? topBlocked;

  /// Most active client
  @JsonKey(name: r'top_client', required: false, includeIfNull: false)
  final String? topClient;

  /// Number of active clients
  @JsonKey(name: r'active_clients', required: false, includeIfNull: false)
  final int? activeClients;

  /// Gravity list size
  @JsonKey(name: r'gravity_size', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'iface', required: false, includeIfNull: false)
  final PaddIface? iface;

  /// Pi-hole host's name
  @JsonKey(name: r'node_name', required: false, includeIfNull: false)
  final String? nodeName;

  /// Host model
  @JsonKey(name: r'host_model', required: false, includeIfNull: false)
  ...
  factory GetPadd200Response.fromJson(Map<String, dynamic> json) =>
      _$GetPadd200ResponseFromJson(json);
