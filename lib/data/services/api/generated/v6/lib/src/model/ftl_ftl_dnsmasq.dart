...
class FtlFtlDnsmasq {
  ...
  @JsonKey(name: r'dns_cache_inserted', required: false, includeIfNull: false)
  final int? dnsCacheInserted;

  /// Number of freed live entries in DNS cache
  @JsonKey(name: r'dns_cache_live_freed', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'dns_auth_answered', required: false, includeIfNull: false)
  final int? dnsAuthAnswered;

  /// Number of DNS queries answered from local cache
  @JsonKey(name: r'dns_local_answered', required: false, includeIfNull: false)
  final int? dnsLocalAnswered;

  /// Number of DNS queries answered from local cache (stale entries)
  @JsonKey(name: r'dns_stale_answered', required: false, includeIfNull: false)
  final int? dnsStaleAnswered;

  /// Number of unanswered DNS queries
  @JsonKey(name: r'dns_unanswered', required: false, includeIfNull: false)
  final int? dnsUnanswered;

  /// Number of BOOTP requests
  @JsonKey(name: r'bootp', required: false, includeIfNull: false)
  final int? bootp;

  /// Number of PXE requests
  @JsonKey(name: r'pxe', required: false, includeIfNull: false)
  final int? pxe;

  /// Number of DHCP ACK
  @JsonKey(name: r'dhcp_ack', required: false, includeIfNull: false)
  final int? dhcpAck;

  /// Number of DHCP DECLINE
  @JsonKey(name: r'dhcp_decline', required: false, includeIfNull: false)
  final int? dhcpDecline;

  /// Number of DHCP DISCOVER
  @JsonKey(name: r'dhcp_discover', required: false, includeIfNull: false)
  final int? dhcpDiscover;

  /// Number of DHCP INFORM
  @JsonKey(name: r'dhcp_inform', required: false, includeIfNull: false)
  final int? dhcpInform;

  /// Number of DHCP NAK
  @JsonKey(name: r'dhcp_nak', required: false, includeIfNull: false)
  final int? dhcpNak;

  /// Number of DHCP OFFER
  @JsonKey(name: r'dhcp_offer', required: false, includeIfNull: false)
  final int? dhcpOffer;

  /// Number of DHCP RELEASE
  @JsonKey(name: r'dhcp_release', required: false, includeIfNull: false)
  final int? dhcpRelease;

  /// Number of DHCP REQUEST
  @JsonKey(name: r'dhcp_request', required: false, includeIfNull: false)
  final int? dhcpRequest;

  /// Number of DHCP requests without answer (rapid commit)
  @JsonKey(name: r'noanswer', required: false, includeIfNull: false)
  final int? noanswer;

  /// Number of allocated IPv4 leases
  @JsonKey(name: r'leases_allocated_4', required: false, includeIfNull: false)
  final int? leasesAllocated4;

  /// Number of pruned IPv4 leases
  @JsonKey(name: r'leases_pruned_4', required: false, includeIfNull: false)
  final int? leasesPruned4;

  /// Number of allocated IPv6 leases
  @JsonKey(name: r'leases_allocated_6', required: false, includeIfNull: false)
  final int? leasesAllocated6;

  /// Number of pruned IPv6 leases
  @JsonKey(name: r'leases_pruned_6', required: false, includeIfNull: false)
  final int? leasesPruned6;

  /// Number of dedicated TCP workers
  @JsonKey(name: r'tcp_connections', required: false, includeIfNull: false)
  final int? tcpConnections;

  /// Number of DHCP lease queries
  @JsonKey(name: r'dhcp_leasequery', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'dhcp_lease_actve', required: false, includeIfNull: false)
  final int? dhcpLeaseActve;

  /// Number of DHCP lease unknown
  @JsonKey(name: r'dhcp_lease_unknown', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'dnssec_max_sig_fail', required: false, includeIfNull: false)
  final int? dnssecMaxSigFail;

  /// DNSSEC per-query subqueries HWM
  @JsonKey(name: r'dnssec_max_work', required: false, includeIfNull: false)
  final int? dnssecMaxWork;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is FtlFtlDnsmasq &&
  ...
  factory FtlFtlDnsmasq.fromJson(Map<String, dynamic> json) =>
      _$FtlFtlDnsmasqFromJson(json);
