...
class GetDnsLog200Response {
  ...
  GetDnsLog200Response({this.log, this.nextID, this.pid, this.file, this.took});
  ...
  @JsonKey(name: r'nextID', required: false, includeIfNull: false)
  final int? nextID;
  ...
  factory GetDnsLog200Response.fromJson(Map<String, dynamic> json) =>
      _$GetDnsLog200ResponseFromJson(json);
