...
class SessionsListSessionsInner {
  ...
  @JsonKey(name: r'current_session', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'cli', required: false, includeIfNull: false)
  final bool? cli;

  /// Timestamp of login (seconds since epoch)
  @JsonKey(name: r'login_at', required: false, includeIfNull: false)
  final int? loginAt;
  ...
  @JsonKey(name: r'valid_until', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'user_agent', required: false, includeIfNull: false)
  final String? userAgent;

  /// IP address of the client (if behind a proxy, optional)
  @JsonKey(name: r'x_forwarded_for', required: false, includeIfNull: false)
  final String? xForwardedFor;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is SessionsListSessionsInner &&
          other.id == id &&
  ...
  factory SessionsListSessionsInner.fromJson(Map<String, dynamic> json) =>
      _$SessionsListSessionsInnerFromJson(json);
