...
class SchemasQueriesQueriesInnerClient {
  ...
  SchemasQueriesQueriesInnerClient({this.ip, this.name});
  ...
  bool operator ==(Object other) =>
      ...
      other is SchemasQueriesQueriesInnerClient &&
          other.ip == ip &&
          other.name == name;
  ...
  factory SchemasQueriesQueriesInnerClient.fromJson(
    Map<String, dynamic> json,
  ) => _$SchemasQueriesQueriesInnerClientFromJson(json);

  Map<String, dynamic> toJson() =>
      _$SchemasQueriesQueriesInnerClientToJson(this);
