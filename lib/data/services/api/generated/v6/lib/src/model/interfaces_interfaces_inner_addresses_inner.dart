...
class InterfacesInterfacesInnerAddressesInner {
  ...
  @JsonKey(name: r'address_type', required: false, includeIfNull: false)
  final String? addressType;

  /// Interface broadcast address
  @JsonKey(name: r'broadcast', required: false, includeIfNull: false)
  final String? broadcast;

  /// Type of the broadcast address
  @JsonKey(name: r'broadcast_type', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'local_type', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'prefixlen', required: false, includeIfNull: false)
  final int? prefixlen;
  ...
  @JsonKey(name: r'prefered', required: false, includeIfNull: false)
  final int? prefered;

  /// Valid lifetime of the address (`4294967295` = forever)
  @JsonKey(name: r'valid', required: false, includeIfNull: false)
  final int? valid;

  /// Creation timestamp of the address
  @JsonKey(name: r'cstamp', required: false, includeIfNull: false)
  final num? cstamp;

  /// Updated timestamp of the address
  @JsonKey(name: r'tstamp', required: false, includeIfNull: false)
  final num? tstamp;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is InterfacesInterfacesInnerAddressesInner &&
  ...
  factory InterfacesInterfacesInnerAddressesInner.fromJson(
    Map<String, dynamic> json,
  ) => _$InterfacesInterfacesInnerAddressesInnerFromJson(json);

  Map<String, dynamic> toJson() =>
      _$InterfacesInterfacesInnerAddressesInnerToJson(this);
