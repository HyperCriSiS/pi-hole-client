...
class PostTeleporterRequestImport {
  ...
  PostTeleporterRequestImport({this.config, this.dhcpLeases, this.gravity});
  ...
  @JsonKey(name: r'dhcp_leases', required: false, includeIfNull: false)
  ...
  bool operator ==(Object other) =>
      ...
      other is PostTeleporterRequestImport &&
          other.config == config &&
          other.dhcpLeases == dhcpLeases &&
          other.gravity == gravity;

  @override
  int get hashCode => config.hashCode + dhcpLeases.hashCode + gravity.hashCode;

  factory PostTeleporterRequestImport.fromJson(Map<String, dynamic> json) =>
      _$PostTeleporterRequestImportFromJson(json);
