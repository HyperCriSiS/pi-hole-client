...
class SchemasListsProcessedProcessedErrorsInner {
  ...
  SchemasListsProcessedProcessedErrorsInner({this.item, this.error});
  ...
  bool operator ==(Object other) =>
      ...
      other is SchemasListsProcessedProcessedErrorsInner &&
          other.item == item &&
          other.error == error;
  ...
  factory SchemasListsProcessedProcessedErrorsInner.fromJson(
    Map<String, dynamic> json,
  ) => _$SchemasListsProcessedProcessedErrorsInnerFromJson(json);

  Map<String, dynamic> toJson() =>
      _$SchemasListsProcessedProcessedErrorsInnerToJson(this);
