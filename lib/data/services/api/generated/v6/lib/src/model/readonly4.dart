...
class Readonly4 {
  /// Returns a new [Readonly4] instance.
  Readonly4({
    this.id,
  ...
  factory Readonly4.fromJson(Map<String, dynamic> json) =>
      _$Readonly4FromJson(json);

  Map<String, dynamic> toJson() => _$Readonly4ToJson(this);
