...
class SessionSession {
  ...
  @JsonKey(name: r'totp', required: true, includeIfNull: false)
  final bool totp;

  /// Session ID
  @JsonKey(name: r'sid', required: true, includeIfNull: true)
  final String? sid;

  /// CSRF token
  @JsonKey(name: r'csrf', required: false, includeIfNull: false)
  final String? csrf;

  /// Remaining lifetime of this session unless refreshed (seconds)
  @JsonKey(name: r'validity', required: true, includeIfNull: false)
  final int validity;
  ...
  factory SessionSession.fromJson(Map<String, dynamic> json) =>
      _$SessionSessionFromJson(json);
