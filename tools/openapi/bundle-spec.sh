...
# Pin every remote input so generated API changes are reproducible.
FTL_REPO="https://github.com/pi-hole/FTL.git"
FTL_REF="${FTL_REF:-fa65a88f8cdef1013594d4de14108077954faea4}" # Pi-hole FTL v6.7
SPECS_PATH="src/api/docs/content/specs"
REDOCLY_CLI_VERSION="${REDOCLY_CLI_VERSION:-2.51.2}"
